...
Testing - Tobias (bare fordi eg skrev noen manuelle tester ;-;)
...
- Effektivisering av team programmering (diskutere, komme fram til løsning, implementere løsning).

- Bedre fordeling av arbeidsoppgaver. Mer spesifikk

- Skriving av mer manuelle tester(lett) og begynne Junit testing(vanskelig)
